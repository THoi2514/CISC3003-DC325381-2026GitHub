...
<header class="site-header">
    ...
    <nav>
        <a href="<?= htmlspecialchars($wb . 'index.php', ENT_QUOTES, 'UTF-8') ?>">Contact</a>
        <a href="<?= htmlspecialchars($pb . 'register.php', ENT_QUOTES, 'UTF-8') ?>">Register interest</a>
        <a href="<?= htmlspecialchars($pb . 'dashboard.php', ENT_QUOTES, 'UTF-8') ?>">Dashboard</a>
        <a href="<?= htmlspecialchars($pb . 'debug_mail.php', ENT_QUOTES, 'UTF-8') ?>">Mail debug</a>
